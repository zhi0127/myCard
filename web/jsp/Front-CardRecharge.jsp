...
<head>
	...
	<script src=<%=jsPath + "Front-CardRecharge.js"%>></script>
			...
			<div class="panel panel-primary" style="margin-top: 30px;">
				...
				<form class="form-horizontal" role="form" id="changeCardForm">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<div class="col-sm-7">
								<label class="control-label" for="rechargeMoney"
								       style="margin-left: 30%">请输入充值金额:</label>
								<input class="form-control" id="rechargeMoney" type="text" maxlength="4"
								       onkeyup="value=value.replace(/[^0-9]/g,'')"/>
							</div>
						</div>
					</div>
					<div class="panel-footer">
						<button class="btn btn-primary btn-default active" type="button" onclick="cardRecharge()">充值
						</button>
					</div>
