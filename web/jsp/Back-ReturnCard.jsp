...
<head>
	...
	<script src=<%=jsPath + "Back-ReturnCard.js"%>></script>
			...
			<div class="panel panel-primary" style="margin-top: 30px;">
				...
				<div class="panel-heading">
					<h3 class="panel-title">
						退卡<input type="hidden" id="myID">
					</h3>
				</div>
				<form class="form-horizontal" role="form" id="returnCardForm"
				      action=<%=path+"/BackReturnCardServlet"%> method="post">
					...
					<input type="hidden" id="returnMoney" name="returnMoney" value="${requestScope.returnMoney}">

					<div class="panel-body">
						<div class="form-group">
							<div class="col-sm-6 name">
								<label class="control-label">请输入原卡号(卡前缀大写):</label>
					...
					<div class="panel-footer">
						<button class="btn btn-primary btn-default active" type="button" onclick="returnCardMethod()">
							退卡
						</button>
					</div>
				</form>
