...
@WebServlet(name = "BackCancelServlet", urlPatterns = "/BackCancelServlet")
public class BackCancelServlet extends HttpServlet

{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		TbPageSearch psu = cardAction.cancelPageSearch(cardHead, startNum, endNum, cardState, startTime, endTime, startPage);
		...
		request.getRequestDispatcher("jsp/Back-CancelCard.jsp").forward(request, response);
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		CardAction cardAction = new CardAction();
		TbPageSearch psu = cardAction.cancelPageSearch(null, null, null, null, null, null, 1);
		TbSelectType selectType = cardAction.getSelectType();
		String loginID = request.getParameter("loginID");
		String loginName = request.getParameter("loginName");
		request.setAttribute("loginID", loginID);
